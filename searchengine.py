...
class crawler:
	...
	def createindextables(self):
		...
		#--------------------------PAGE RANK ALG0-----------------
	#SET RANKS OF ALL PAGES TO 1 INITIALLY THEN LOOP OVER THEM FOR SUFFICIENT
	# TIMES TO CALCLULATE PAGERANK
	def calculatepagerank(self,iterations=10):
		#clear current page rank tables
		...
		for i in range(iterations):
			...
			for(urlid,) in self.con.execute('select rowid from urllist'):
				pr=0.15
			#loop through all the pages that link to this url
